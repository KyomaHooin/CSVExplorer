...
; =======================================================================================
Func _GraphGDIPlus_Set_RangeX(ByRef $aGraphArray, $iLow, $iHigh, $XLabelArray, $iXTicks = 1, $bLabels = 1, $iRound = 0)
	If IsArray($aGraphArray) = 0 Then Return
	...
	For $i = 1 To $iXTicks + 1
		...
		$ahTicksLabelsX[$i] = GUICtrlCreateLabel("boo", _
	...
	If $bLabels = 1 Then
		For $i = 1 To (UBound($ahTicksLabelsX) - 1)
;			GUICtrlSetData($ahTicksLabelsX[$i], $XLabelArray[$i])
			GUICtrlSetData($ahTicksLabelsX[$i], $XLabelArray[_GraphGDIPlus_Reference_Pixel("p", (($i - 1) * ($aGraphArray[4] / $iXTicks)), _
